SELECT dc.REG_ANS, roa.Razao_Social, SUM(CAST(dc.VL_SALDO_FINAL as DECIMAL(10,2))-CAST(dc.VL_SALDO_INICIAL as DECIMAL(10,2))) FROM demonstracoes_contabeis_2021_4t AS dc 
